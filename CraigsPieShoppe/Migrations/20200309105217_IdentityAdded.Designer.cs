...
namespace CraigsPieShoppe.Migrations
{
    ...
    [Migration("20200309105217_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CraigsPieShoppe.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("CraigsPieShoppe.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("CraigsPieShoppe.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("CraigsPieShoppe.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CraigsPieShoppe.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("CraigsPieShoppe.Models.OrderDetail", b =>
                {
                    b.HasOne("CraigsPieShoppe.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CraigsPieShoppe.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CraigsPieShoppe.Models.Pie", b =>
                {
                    b.HasOne("CraigsPieShoppe.Models.Category", "Category")
                        .WithMany("Pies")
